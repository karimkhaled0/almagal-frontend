      ...
      <div className="grid grid-cols-4 gap-x-10">
        ...
        <div className="space-y-1">
          ...
          <p className="lg:text-base md:text-sm text-[6px] md:w-full w-20 font-normal text-[#676767] md:p-2 p-0">
            شركة المجال للقضاء و مكافحة الحشرات في السعودية - نحن نقدم خدمات
            متخصصة في مكافحة جميع أنواع الحشرات الضارة في مناطق الدمام، الخبر،
            الظهران، القطيف، سيهات، وعنك
          </p>
        </div>
      </div>
      {/* Privacy */}
